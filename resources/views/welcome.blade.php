...
<html lang="en-US">
  <head>
    ...
    <link href="{{ asset('../css/wec/font-awesome/css/all.min.css?ver=1.2.0')}}" rel="stylesheet">
    <link href="{{ asset('../css/wec/bootstrap-icons/bootstrap-icons.css?ver=1.2.0')}}" rel="stylesheet">
    <link href="{{ asset('../css/wec/bootstrap.min.css?ver=1.2.0')}}" rel="stylesheet">
    <link href="{{ asset('../css/wec/aos.css?ver=1.2.0')}}" rel="stylesheet">
    <link href="{{ asset('../css/wec/main.css?ver=1.2.0')}}" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
  ...
  <body id="top">
    <header class="bg-light">
      <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
        <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#">AdSwipe</a>
...
<header>
  <div class="cover bg-light">
    <div class="container px-3">
      <div class="row">
        <div class="col-lg-6 p-2"><img class="img-fluid" src="https://preview.wstacks.com/adstack/assets/images/frontend/banner/64f73071b37991693921393.png" alt="hello"/></div>
        <div class="col-lg-6">
          <div class="mt-5">
...
<div class="section pt-4 px-3 px-lg-4" id="about">
  <div class="container-narrow">
    <div class="row">
      <div class="col-md-6">
        <h2 class="h4 my-2">What About AdSwipe NetWorking</h2>

        <p>
        Ad networking refers to the infrastructure and environment enabling the exchange of advertisements between various applications and online platforms. This includes multiple stakeholders such as publishers (who provide ad space) and advertisers (who promote their products or services).
        </p>

      </div>
      <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img class="avatar img-fluid mt-2" src="../images/f/ad-networks-1.jpg" width="400" height="400" alt="Walter Patterson"/></div>
    </div>
  </div>
</div>
  ...
  <div class="container-narrow">
    ...
    <div class="text-center">
        <p class="mx-auto mb-3" style="max-width:600px">
            Our ad exchange platform offers a user-friendly interface for quick and easy deployment. It combines real-world performance metrics with imaginative projections, ensuring advertisers experience efficient campaigns. With dynamic ad matching and seamless communication, our platform facilitates optimal ad placement for impactful results.
        </p>
    </div>
    <div class="row py-3">
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="100"><img class="mb-2" src="../images/ads-svgrepo.svg" width="96" height="96" alt="web design"/>
        <div class="h5">Ads Different</div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="200"><img class="mb-2" src="../images/website_seo.svg" width="96" height="96" alt="graphic design"/>
        <div class="h5">Our Advertising Platform</div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="300"><img class="mb-2" src="../images/website.svg" width="96" height="96" alt="ui-ux"/>
...
<footer class="pt-4 pb-4 text-center bg-light">
  <div class="container">
    ...
    <script src="../js/wec/imagesloaded.pkgd.min.js?ver=1.2.0"></script>
    <script src="../js/wec/masonry.pkgd.min.js?ver=1.2.0"></script>
    <script src="../js/wec/BigPicture.min.js?ver=1.2.0"></script>
    <script src="../js/wec/purecounter.min.js?ver=1.2.0"></script>
    <script src="../js/wec/bootstrap.bundle.min.js?ver=1.2.0"></script>
    <script src="../js/wec/aos.min.js?ver=1.2.0"></script>
    <script src="../js/wec/main.js?ver=1.2.0"></script>
  </body>
</html>
